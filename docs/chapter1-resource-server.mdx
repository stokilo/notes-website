...
<SwiperImageCarousel
  images={[
    { src: '/img/chapter1/screenshot_1YjGmo5BZ.png', alt: 'Screenshot 1' },
    { src: '/img/chapter1/screenshot_25ph2hZD.png', alt: 'Screenshot 2'},
    { src: '/img/chapter1/screenshot_3sY4Fyvp.png', alt: 'Screenshot 3'},
    { src: '/img/chapter1/screenshot_4sKWbEZG.png', alt: 'Screenshot 4'},
    { src: '/img/chapter1/screenshot_5BHOyiYq.png', alt: 'Screenshot 5'},
    { src: '/img/chapter1/screenshot_6YSXwngq.png', alt: 'Screenshot 6'},
    { src: '/img/chapter1/screenshot_7JtNbPRT.png', alt: 'Screenshot 7'}
  ]} />
...
<SwiperImageCarousel
  images={[
    { src: '/img/chapter1/screenshot_11xB0UU10.png', alt: 'Screenshot 1' },
    { src: '/img/chapter1/screenshot_22TJvsZ5L.png', alt: 'Screenshot 2' },
    { src: '/img/chapter1/screenshot_33CvqNiNB.png', alt: 'Screenshot 3' },
    { src: '/img/chapter1/screenshot_44jdqTRaC.png', alt: 'Screenshot 4' }
  ]} />

**Get Keycloak Issuer URL and JWKS URI:**
<SwiperImageCarousel
  images={[
    { src: '/img/chapter1/screenshot_11wHO3uI8.png', alt: 'Screenshot 1' },
    { src: '/img/chapter1/screenshot_22tsArqLB.png', alt: 'Screenshot 2' },
    { src: '/img/chapter1/screenshot_33j4B1kt2.png', alt: 'Screenshot 3' }
  ]} />
...
<SwiperImageCarousel
  images={[
    { src: '/img/chapter1/screenshot_11taxd6nh.png', alt: 'Screenshot 1' },
    { src: '/img/chapter1/screenshot_221toYigy.png', alt: 'Screenshot 2' },
    { src: '/img/chapter1/screenshot_33mLFBTOo.png', alt: 'Screenshot 3' }
  ]} />
...
<SwiperImageCarousel
  images={[
    { src: '/img/chapter1/screenshot_11Vqeamit.png', alt: 'Screenshot 1'},
    { src: '/img/chapter1/screenshot_22FsB2xg5U.png', alt: 'Screenshot 2'},
    { src: '/img/chapter1/screenshot_33J9bAgXC.png', alt: 'Screenshot 3'},
    { src: '/img/chapter1/screenshot_44acNr2Jwe.png', alt: 'Screenshot 4'},
    { src: '/img/chapter1/screenshot_55NbA2v2hG.png', alt: 'Screenshot 5'},
    { src: '/img/chapter1/screenshot_66HOSPvmRB.png', alt: 'Screenshot 6'},
    { src: '/img/chapter1/screenshot_77sPCu4cdn.png', alt: 'Screenshot 7'}
  ]} />
